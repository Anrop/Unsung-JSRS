class CfgPatches {
    class anrop_unsung_jsrs_vehicles_ch53 {
        name = "anrop_unsung_jsrs_vehicles_ch53";
        units[] = {};
        weapons[] = {};
        requiredVersion = 1.0;
        requiredAddons[] = {"uns_ch53_c", "jsrs_soundmod_complete_edition"};
        addonRootClass = "uns_ch53_c";
        author = "Anrop";
...
class CfgVehicles
{
    ...
    class uns_ch53_base: Helicopter_Base_F
    {
        ...
        class sounds
        {
            ...
            class rotorint
            {
                sound[] = {"\jsrs_soundmod_complete\JSRS_Soundmod_Soundfiles\air_vehicles\CH49_Mohawk\int_speed_down.ogg",0.75,1};
                frequency = "(rotorspeed factor [0.3, 0.7]) * (rotorspeed factor [0.3, 1]) * (1 - rotorthrust/4)";
            ...
            class fardistance
            {
                sound[] = {"\jsrs_soundmod_complete\JSRS_Soundmod_Soundfiles\air_vehicles\CH49_Mohawk\rotor_far.ogg",0.75,1,3750};
                frequency = "rotorspeed";
