class CfgPatches {
    class anrop_unsung_jsrs_vehicles_mi8 {
        name = "anrop_unsung_jsrs_vehicles_mi8";
        units[] = {};
        weapons[] = {};
        requiredVersion = 1.0;
        requiredAddons[] = {"uns_mi8_c", "jsrs_soundmod_complete_edition"};
        addonRootClass = "uns_mi8_c";
        author = "Anrop";
...
class CfgVehicles 
{
    ...
    class uns_Mi8TV_base: Helicopter_Base_F
    {
        ...
        soundengineonint[] = {"\jsrs_soundmod_complete\JSRS_Soundmod_Soundfiles\air_vehicles\Mi8_Mil\int_start.ogg",1,1};
        soundengineonext[] = {"\jsrs_soundmod_complete\JSRS_Soundmod_Soundfiles\air_vehicles\Mi8_Mil\ext_start.ogg",1,1,300};
        soundengineoffint[] = {"\jsrs_soundmod_complete\JSRS_Soundmod_Soundfiles\air_vehicles\Mi8_Mil\int_off.ogg",1,1};
        soundengineoffext[] = {"\jsrs_soundmod_complete\JSRS_Soundmod_Soundfiles\air_vehicles\Mi8_Mil\ext_off.ogg",1,1,300};
        ...
        class sounds
        {
            ...
            class engineext
            {
                sound[] = {"\jsrs_soundmod_complete\JSRS_Soundmod_Soundfiles\air_vehicles\Mi8_Mil\engine_close.ogg",1.5,1,300};
                frequency = "(rotorspeed factor [0.3, 0.7]) * (rotorspeed factor [0.3, 1]) * (1 - rotorthrust/4)";
                volume = "2*campos*(0 max (rotorspeed-0.4))";
            };
            class rotorext
            {
                sound[] = {"\jsrs_soundmod_complete\JSRS_Soundmod_Soundfiles\air_vehicles\Mi8_Mil\rotor_close.ogg",1.6,1,300};
                frequency = "rotorspeed";
                volume = "campos*2*(rotorspeed factor [0.3, 1]) * (1 + rotorthrust)";
            };
            class rotorswist
            {
                sound[] = {"\jsrs_soundmod_complete\JSRS_Soundmod_Soundfiles\air_vehicles\Mi8_Mil\tail_rotor.ogg",1,1,200};
                frequency = 1;
                volume = "campos * (rotorthrust factor [0.7, 0.9])";
            };
            class engineint
            {
                sound[] = {"\jsrs_soundmod_complete\JSRS_Soundmod_Soundfiles\air_vehicles\Mi8_Mil\int_main.ogg",1,1};
                frequency = "(rotorspeed factor [0.3, 0.7]) * (rotorspeed factor [0.3, 1]) * (1 - rotorthrust/4)";
                volume = "(1-campos)*2*(0 max (rotorspeed-0.4))";
            };
            class rotorint
            {
                sound[] = {"\jsrs_soundmod_complete\JSRS_Soundmod_Soundfiles\air_vehicles\Mi8_Mil\int_speed_down.ogg",0.75,1};
                frequency = "(rotorspeed factor [0.3, 0.7]) * (rotorspeed factor [0.3, 1]) * (1 - rotorthrust/4)";
            ...
            class distance
            {
                sound[] = {"\jsrs_soundmod_complete\JSRS_Soundmod_Soundfiles\air_vehicles\Mi8_Mil\engine_far.ogg",1,1,1000};
                frequency = "rotorspeed";
                volume = "2 * campos * (0 max (rotorspeed-0.4))";
            };
            class fardistance
            {
                sound[] = {"\jsrs_soundmod_complete\JSRS_Soundmod_Soundfiles\air_vehicles\Mi8_Mil\rotor_far.ogg",0.75,1,3750};
                frequency = "rotorspeed";
